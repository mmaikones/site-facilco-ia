...
const Header: React.FC<HeaderProps> = ({ toggleChat }) => {
  ...
  return (
    <>
      <div className="bg-brand-dark text-white py-2 text-xs border-b border-gray-800 hidden md:block">
        <div className="container mx-auto px-4 flex justify-between items-center">
          <div className="flex space-x-6">
            ...
            <span><i className="fas fa-envelope text-brand-yellow mr-2"></i>engenharia@facilco.com.br</span>
            <span><i className="fas fa-phone text-brand-yellow mr-2"></i>(19) 99622-3433</span>
          </div>
