...
const allProducts: CatalogItem[] = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1585713181935-d5f622cc2415?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    category: "Proteção"
  },
  {
    id: 3,
  ...
  // --- TRABALHO EM ALTURA ---
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1661962360526-724575bf4321?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1455849318743-b2233052fcff?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    category: "Trabalho em Altura"
  },
  {
    id: 8,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1542601906990-b4d3fb7d5c73?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    category: "Trabalho em Altura"
  },
  {
    id: 10,
    ...
    image: "https://images.unsplash.com/photo-1596496181848-3091d4878b24?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    category: "Trabalho em Altura"
  },
  ...
  // --- LOGÍSTICA ---
  {
    ...
    image: "https://images.unsplash.com/photo-1590649802313-79357497d530?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    category: "Logística"
  },
  {
    id: 12,
    ...
    image: "https://images.unsplash.com/photo-1591768793355-74d04bb6608f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    category: "Logística"
  },
  {
    id: 13,
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1626116187625-f55979c09424?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80",
    category: "Logística"
  }
];
                         ...
                         idx % itemsPerPage === 0 && (
                            <button
                                ...
                                className={`h-2 rounded-full transition-all duration-300 ${
                                    currentIndex >= idx && currentIndex < idx + itemsPerPage 
                                        ? 'w-8 bg-brand-yellow' 
                                        : 'w-2 bg-gray-300'
                                }`}
